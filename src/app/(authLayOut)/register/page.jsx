...
//     const buttonSwipe = pathname.toLocaleLowerCase() === 'login' || pathname.toLocaleLowerCase() === 'register'
//     if (!buttonSwipe) {
//         return { children }
//     }
//     return (
//         <div className="bg-gray-50 flex items-center flex-col justify-center min-h-screen">
//             <div className="flex items-center mb-3 justify-center ">
//                 <Link href={'/login'}>
//                     <Button
//                         className={`rounded-none hover:bg-[#00b0f2]/60 ${pathname === '/login' ? 'bg-[#00b0f2] text-white' : 'bg-gray-200 text-black'}`}
//                     >
//                         Login
//                     </Button>
//                 </Link>
//                 <Link href={'/register'}>
//                     <Button
//                         className={`rounded-none hover:bg-[#00b0f2]/70 ${pathname === '/register' ? 'bg-[#00b0f2] text-white' : 'bg-gray-200 text-black'}`}
//                     >
//                         Register
//                     </Button>
//                 </Link>
